...
dont_add = set()
for samples in error_cases.values():
    for sample in samples:
        dont_add.add(sample)

base_dir = './datasets/juizdebocha-raw'

for filename in os.listdir(f'{base_dir}/removed'):
    dont_add.add(filename)

for filename in os.listdir(f'{base_dir}/raw'):
    if filename not in dont_add:
        os.system(f'cp {base_dir}/raw/{filename} {base_dir}/dataset/data/{filename}')
